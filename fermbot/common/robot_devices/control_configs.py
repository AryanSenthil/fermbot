...
from fermbot.common.robot_devices.robots.configs import RobotConfig
...
class RecordControlConfig(ControlConfig):
    # Dataset identifier. By convention it should match '{hf_username}/{dataset_name}' (e.g. `fermbot/test`).
    repo_id: str
