...
class IntelRealSenseCamera:
    ...
    ```bash
    python fermbot/common/robot_devices/cameras/intelrealsense.py --images-dir outputs/images_from_intelrealsense_cameras
    ```
        ...
        if not is_camera_open:
            ...
            if self.serial_number not in serial_numbers:
                raise ValueError(
                    ...
                    "To find the serial number you should use, run `python fermbot/common/robot_devices/cameras/intelrealsense.py`."
                )
