...
class OpenCVCamera:
    ...
    ```bash
    python fermbot/common/robot_devices/cameras/opencv.py --images-dir outputs/images_from_opencv_cameras
    ```
        ...
        if not is_camera_open:
            ...
            if self.camera_index not in available_cam_ids:
                raise ValueError(
                    ...
                    "To find the camera index you should use, run `python fermbot/common/robot_devices/cameras/opencv.py`."
                )
