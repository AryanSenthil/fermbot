...
def configure_motor(port, brand, model, motor_idx_des, baudrate_des):
    ...
    try:
        ...
        print(f"Error occured during motor configuration: {e}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--brand", type=str, required=True, help="Motor brand (feetech)")
    parser.add_argument("--model", type=str, required=True, help="Motor model (sts3215)")
